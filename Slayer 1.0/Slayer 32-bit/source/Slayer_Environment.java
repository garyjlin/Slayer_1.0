...
public class Slayer_Environment extends PApplet {
...
public void setup(){
  ...
  x = PApplet.parseInt(inputStr[0]);
  y = PApplet.parseInt(inputStr[1]);
  backX = x-1000;
  backY = y-1000;
  backX2 = x-1000;
  backY2 = y-1000 + 2000;
  backLength = 2000;
  envX[0] = PApplet.parseInt(inputStr[2]);  
  envY[0] = PApplet.parseInt(inputStr[3]);
  envX[1] = envX[0] + 500;
  envY[1] = envY[0];
  hei[0] = 200;
  hei[1] = 150;
...
public void exit(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "Slayer_Environment" };
    if (passedArgs != null) {
